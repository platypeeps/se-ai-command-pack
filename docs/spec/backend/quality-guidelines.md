...
pattern; a diff mixing tooling with authored prose (e.g. `docs/spec/**`,
...
printf 'body\n' > "$d/body.md"
printf '.trellis/tasks/archive/2026-08/08-10-review-scope-late-arrival/prd.md\0docs/spec/backend/quality-guidelines.md\0' \
  > "$d/paths.nul"
...
5. **Neither registry matches: repo-owned.** Edit freely under normal review.
   This file (`docs/spec/backend/quality-guidelines.md`) is the standing
   example.
...
| `docs/spec/backend/quality-guidelines.md` | no registry — repo-owned |
