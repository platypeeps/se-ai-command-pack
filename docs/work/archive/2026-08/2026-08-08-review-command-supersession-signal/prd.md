---
title: Superseded review commands carry no supersession signal in their peer adapters or frontmatter
status: done
created: 2026-08-08
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-08-review-command-supersession-signal`:
