---
title: sd-review cannot record a rebutted local finding
status: done
created: 2026-08-06
branch: task/08-06-sd-review-local-rebuttal-gap
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-06-sd-review-local-rebuttal-gap`:

- failclosed-probe.txt
- refresh-apply.txt
- refresh-check.json
- refresh-dryrun.json
- refresh-dryrun.txt
- refresh-source-and-conflicts.md
- research/refresh-diff-review.md
- upstream-tests.txt
