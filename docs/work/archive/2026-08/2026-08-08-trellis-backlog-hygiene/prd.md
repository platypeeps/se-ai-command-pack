---
title: "Trellis backlog hygiene: stale unmarked tasks, order collisions, committed detritus"
status: done
created: 2026-08-08
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-08-trellis-backlog-hygiene`:

- record.md
- research/order-semantics.md
