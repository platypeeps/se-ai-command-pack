---
title: Roll out dispatch protocols to remaining fan-out skills
status: done
created: 2026-07-25
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/07-25-dispatch-rollout`:

- pattern-conformance.md
- research/pilot-pattern.md
- research/target-skills.md
- research/validation-requirements.md
