---
title: "SD pack twin: registry snapshot producer parity"
status: done
created: 2026-08-04
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-04-audit-registry-snapshot-sd-twin`:
