---
title: Replace brittle prose pins in se-coherence-audit skill tests with contract assertions
status: done
created: 2026-08-28
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-28-coherence-audit-test-contracts`:
