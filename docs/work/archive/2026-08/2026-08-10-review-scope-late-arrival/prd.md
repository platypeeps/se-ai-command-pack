---
title: Close the pack.review-scope late-arrival gap for mixed diffs
status: done
created: 2026-08-10
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-10-review-scope-late-arrival`:
