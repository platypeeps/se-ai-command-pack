---
title: Review controller caches sd-check results under an identity that omits the PR body
status: done
created: 2026-08-10
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-10-review-check-cache-pr-body`:
