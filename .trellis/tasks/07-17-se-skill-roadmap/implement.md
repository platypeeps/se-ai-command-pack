...
1. Treat the 47 archived children reported by Trellis as complete.
...
2. Under an unfiltered autonomous backlog run, activate the highest-ranked
   implementation-ready child from live state. `se-video-notes`, the latest
...
1. Capture and knowledge operations: `se-watchlist`, `se-weekly-review`.
2. Complete `personal-worklog-profile` as a separate P3 design decision; create
