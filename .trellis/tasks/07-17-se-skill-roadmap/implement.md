...
1. Treat the 48 archived children reported by Trellis as complete.
...
2. Under an unfiltered autonomous backlog run, activate the highest-ranked
   implementation-ready child from live state. `se-watchlist`, the latest
...
1. Capture and knowledge operations: `se-weekly-review`.
