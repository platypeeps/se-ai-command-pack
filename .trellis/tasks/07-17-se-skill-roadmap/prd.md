...
this reconciliation point, 42 children are completed and archived, 8 remain
...
| Understand and learn | `se-distill`, `se-explain`, `se-literature-map`, `se-compare`, `se-learn`, `se-study-guide`, `se-socratic-review` | 6 completed, 1 planning |
...
| Coordinate and operate | `se-stakeholder-map`, `se-feedback`, `se-agenda`, `se-runbook`, `se-sop`, `se-checklist` | 5 completed, 1 planning |
