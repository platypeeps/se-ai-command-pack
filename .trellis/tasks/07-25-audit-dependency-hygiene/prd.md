...
- Planning depth: PRD-only. Pinning and lifecycle-script review are bounded edits with no cross-layer contract. Escalate to `design.md` only if an unpinned transitive turns out to need a lockfile strategy.
