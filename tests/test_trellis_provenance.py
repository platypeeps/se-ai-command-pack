...
class ProvenanceCheckerTest(unittest.TestCase):
    ...
    def write_dual_owned_gitignore(self, banner: str = "sd-ai-command-pack") -> None:
        """A .gitignore with a repo-authored rule and a pack-managed block."""
        self.repo.write(
            ".gitignore",
            "uv.lock\n"
            + self.PACK_BLOCK.replace("sd-ai-command-pack. DO NOT", f"{banner}. DO NOT"),
        )
        status, output = self.repo.run_checker("--write")
        self.assertEqual(status, 0, output)

    def test_pack_block_rewrite_is_not_drift(self) -> None:
        self.write_dual_owned_gitignore()
        self.repo.write(
            ".gitignore",
            "uv.lock\n"
            + self.PACK_BLOCK.replace(
                "# Generated by sd-ai-command-pack. DO NOT EDIT MANUALLY.\n",
                "# Generated by some future pack banner. DO NOT EDIT MANUALLY.\n"
                "/.obsidian-kb-extra\n",
            ),
        )
        status, output = self.repo.run_checker()
        self.assertEqual(status, 0, output)
        self.assertNotIn("drifted: .gitignore", output)

    def test_repo_authored_rule_edit_is_drift(self) -> None:
        self.write_dual_owned_gitignore()
        self.repo.write(".gitignore", "uv.lock\nsneaky-hand-edit\n" + self.PACK_BLOCK)
        status, output = self.repo.run_checker()
        self.assertEqual(status, 1, output)
        self.assertIn("drifted: .gitignore", output)

    def test_unclosed_pack_block_is_malformed(self) -> None:
        self.write_dual_owned_gitignore()
        self.repo.write(
            ".gitignore",
            "uv.lock\n# sd-ai-command-pack obsidian-kb start\n/.obsidian-kb\n",
    ...
    def test_unmatched_pack_block_end_is_malformed(self) -> None:
        self.write_dual_owned_gitignore()
        self.repo.write(".gitignore", "uv.lock\n# sd-ai-command-pack other end\n")
        status, output = self.repo.run_checker()
        self.assertEqual(status, 2, output)
        self.assertIn("without a matching start", output)
