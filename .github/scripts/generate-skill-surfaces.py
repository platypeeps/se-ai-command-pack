...
DEFAULT_MANIFEST_HEADER = {
    ...
    "license": "MIT",
    "description": (
        "Install user-level knowledge-work skills for research, fact checks, "
        "decisions, status reports, discovery, briefs, meeting prep, scans, "
        "and digests into agent skill directories."
    ),
}
